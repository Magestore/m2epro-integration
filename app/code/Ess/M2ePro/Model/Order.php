...
class Order extends ActiveRecord\Component\Parent\AbstractModel
{
    ...
    public function createMagentoOrder()
    {
        try {
            ...
            $this->_eventManager->dispatch('mepro_order_place_integration_inventory', array('order' => $this));
            ...
            /** integration Inventory with M2epro */
            $this->_eventManager->dispatch('mepro_order_place_failure', array('order' => $this));
    ...
    public function afterCreateMagentoOrder()
    {
        ...
        // ---------------------------------------
        /** integration Inventory with M2epro */
        $this->_eventManager->dispatch('mepro_order_place_success', array('order' => $this));
