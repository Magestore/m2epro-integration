...
namespace Magestore\M2eIntegration\Model\Rewrite\Listing\Product;
...
abstract class QtyCalculator extends \Ess\M2ePro\Model\AbstractModel
{
    ...
    public function getProductValue()
    {
        ...
        if($this->getListing()){
            ...
            $warehouse_id = $model->getWarehouseByListing($this->getListing()->getId(),true);
            $this->helperFactory->getObject('Data\GlobalData')->setValue('warehouse_listing_for_integration_m2e',$warehouse_id);
        }
